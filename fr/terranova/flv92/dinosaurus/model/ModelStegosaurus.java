...
public class ModelStegosaurus extends ModelDinosaurs
{
  ...
  public ModelStegosaurus()
  {
    ...
    setRotation(this.H2, 0.20944F, 0.0F, 0.0F);
    this.H2.mirror = true;
    ...
    setRotation(this.H3, 0.1745329F, 0.0F, 0.0F);
    this.H3.mirror = true;
    ...
    setRotation(this.D_L_1, 0.0F, 0.0F, 0.0F);
    ...
    setRotation(this.D_R_1, 0.0F, 0.0F, 0.0F);
    ...
    setRotation(this.D_L_2, 0.8726646F, 0.0F, 0.0F);
    ...
    setRotation(this.D_R_2, 0.8726646F, 0.0F, 0.0F);
    ...
    setRotation(this.DD_L_1, 0.0F, 0.0F, 0.0F);
    ...
    setRotation(this.D_D_R_1, 0.0F, 0.0F, 0.0F);
    ...
    setRotation(this.DD_L_2, 1.22173F, 0.0F, 0.0F);
    ...
    setRotation(this.DD_R_2, 1.22173F, 0.0F, 0.0F);
    ...
    setRotation(this.T4, 0.261799F, 0.0F, 0.0F);
    this.T4.mirror = true;
  }
  ...
  protected void setRotationAngles(float var1, float var2, float var3, float var4, float var5, float var6, boolean var7)
  {
    if (!var7)
    {
      this.H4.rotateAngleY = (MathHelper.cos(var1 / 0.9595538F) * 0.3490658F * var2 + 0.0F);
      this.H5.rotateAngleY = (MathHelper.cos(var1 / 0.9595538F) * 0.4363323F * var2 + 0.0F);
      this.H6.rotateAngleY = (MathHelper.cos(var1 / 0.9595538F) * 0.4886922F * var2 + 0.0F);
      this.D_L_1.rotateAngleX = (MathHelper.cos(var1 / 0.9595538F) * -0.1745329F * var2 + 0.0F);
      this.D_R_1.rotateAngleX = (MathHelper.cos(var1 / 0.9595538F) * 0.1745329F * var2 + 0.0F);
      this.D_L_2.rotateAngleX = (MathHelper.cos(var1 / 0.9595538F) * -0.1745329F * var2 + 0.8726646F);
      this.D_R_2.rotateAngleX = (MathHelper.cos(var1 / 0.9595538F) * 0.1745329F * var2 + 0.8726646F);
      this.DD_L_1.rotateAngleX = (MathHelper.cos(var1 / 0.9595538F) * 0.1745329F * var2 + 0.0F);
      this.DD_L_1.rotateAngleY = (MathHelper.cos(var1 / 0.9595538F) * 0.1745329F * var2 + 0.0F);
      this.D_D_R_1.rotateAngleX = (MathHelper.cos(var1 / 0.9595538F) * -0.1745329F * var2 + 0.0F);
      this.D_D_R_1.rotateAngleY = (MathHelper.cos(var1 / 0.9595538F) * 0.1745329F * var2 + 0.0F);
      this.DD_L_2.rotateAngleX = (MathHelper.cos(var1 / 0.9595538F) * 0.1745329F * var2 + 1.221731F);
      this.DD_L_2.rotateAngleY = (MathHelper.cos(var1 / 0.9595538F) * 0.1745329F * var2 + 0.0F);
      this.DD_R_2.rotateAngleX = (MathHelper.cos(var1 / 0.9595538F) * -0.1745329F * var2 + 1.221731F);
      this.DD_R_2.rotateAngleY = (MathHelper.cos(var1 / 0.9595538F) * 0.1745329F * var2 + 0.0F);
      this.T1.rotateAngleY = (MathHelper.cos(var1 / 0.9595538F) * 0.4886922F * var2 + 0.0F);
      this.T2.rotateAngleY = (MathHelper.cos(var1 / 0.9595538F) * 0.3490658F * var2 + 0.0F);
      this.T2.rotateAngleZ = (MathHelper.cos(var1 / 0.9595538F) * 0.1745329F * var2 + 0.0F);
      this.T3.rotateAngleZ = (MathHelper.cos(var1 / 0.9595538F) * 0.1745329F * var2 + 0.0F);
      this.T4.rotateAngleZ = (MathHelper.cos(var1 / 0.9595538F) * 0.1745329F * var2 + 0.0F);
    }
  }
}