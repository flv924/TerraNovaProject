...
public class ModelBrachiosaur extends ModelDinosaurs
{
  ...
  public ModelBrachiosaur()
  {
    ...
    setRotation(this.Snout, 0.261799F, 0.0F, 0.0F);
    ...
    setRotation(this.Neck1, -0.9599311F, 0.0F, 0.0F);
    ...
    setRotation(this.Neck12, -1.23464F, 0.0F, 0.0F);
    ...
    setRotation(this.Neck121, -1.343904F, 0.0F, 0.0F);
    ...
    setRotation(this.Neck1211, -1.343904F, 0.0F, 0.0F);
    ...
    setRotation(this.Neck1212, -1.343904F, 0.0F, 0.0F);
    ...
    setRotation(this.Neck12121, -1.343904F, 0.0F, 0.0F);
    ...
    setRotation(this.Neck121211, -0.9637522F, 0.0F, 0.0F);
    ...
    setRotation(this.Lower_Neck, -0.8377581F, 0.0F, 0.0F);
    ...
    setRotation(this.Lower_Neck1, -0.390789F, 0.0F, 0.0F);
    ...
    setRotation(this.Body, -0.111536F, 0.0F, 0.0F);
    ...
    setRotation(this.Lower_Body, -0.3346075F, 0.0F, 0.0F);
    ...
    setRotation(this.Front_Thigh, 0.0F, 0.0F, 0.0F);
    ...
    setRotation(this.Front_Thigh1, 0.0F, 0.0F, 0.0F);
    ...
    setRotation(this.Back_CalfRight, 0.0F, 0.0F, 0.0F);
    ...
    setRotation(this.Front_Calf1, 0.0F, 0.0F, 0.0F);
    ...
    setRotation(this.Back_Thigh, 0.0F, 0.0F, 0.0F);
    ...
    setRotation(this.Back_Thigh1, 0.0F, 0.0F, 0.0F);
    ...
    setRotation(this.Front_Calf2, 0.0F, 0.0F, 0.0F);
    ...
    setRotation(this.Back_CalfLeft, 0.0F, 0.0F, 0.0F);
    ...
    setRotation(this.Tail, -0.7064018F, 0.0F, 0.0F);
    ...
    setRotation(this.Tail1, -0.5576873F, 0.0F, 0.0F);
    ...
    setRotation(this.Tail11, -0.3717943F, 0.0F, 0.0F);
  ...
  protected void setRotationAngles(float var1, float var2, float var3, float var4, float var5, float var6, boolean var7)
  {
    if (!var7)
    {
      ...
      this.Front_Thigh1.rotateAngleX = (MathHelper.cos(var1 * 0.6662F + 3.141593F) * 1.4F * var2);
      this.Front_Calf2.rotateAngleX = (MathHelper.cos(var1 * 0.6662F + 3.141593F) * 1.4F * var2);
      this.Back_Thigh1.rotateAngleX = (MathHelper.cos(var1 * 0.6662F + 3.141593F) * 1.4F * var2);
      this.Back_CalfRight.rotateAngleX = (MathHelper.cos(var1 * 0.6662F + 3.141593F) * 1.4F * var2);
