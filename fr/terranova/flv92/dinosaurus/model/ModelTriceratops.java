...
public class ModelTriceratops extends ModelDinosaurs
{
  ...
  public ModelTriceratops()
  {
    ...
    SetRotation(this.noumenon1, 0.0F, 0.0F, 0.0F);
    ...
    SetRotation(this.noumenon2, -0.2712F, 0.0F, 0.0F);
    ...
    SetRotation(this.noumenon3, -0.4519F, 0.0F, 0.0F);
    ...
    SetRotation(this.thigh_R1, 0.0F, 0.0F, 0.0F);
    ...
    SetRotation(this.leg_R1, 1.0F, 0.0F, 0.0F);
    ...
    SetRotation(this.thigh_L1, 0.0F, 0.0F, 0.0F);
    ...
    SetRotation(this.leg_L1, 1.0F, 0.0F, 0.0F);
    ...
    SetRotation(this.thigh_R2, 0.0F, 0.0F, 0.0F);
    ...
    SetRotation(this.leg_R2, 1.0F, 0.0F, 0.0F);
    ...
    SetRotation(this.thigh_L2, 0.0F, 0.0F, 0.0F);
    ...
    SetRotation(this.leg_L2, 1.0F, 0.0F, 0.0F);
    ...
    SetRotation(this.head11, -0.4F, 0.0F, 0.0F);
    ...
    SetRotation(this.horn_1_R, -0.31642F, 0.0F, 0.0F);
    ...
    SetRotation(this.horn_2_L, -0.31642F, 0.0F, 0.0F);
    ...
    SetRotation(this.horn_1_R1, -0.31642F, 0.0F, 0.0F);
    ...
    SetRotation(this.horn_1_R2, -0.31642F, 0.0F, 0.0F);
  }

  public void render(Entity var1, float var2, float var3, float var4, float var5, float var6, float var7)
  {
    super.render(var1, var2, var3, var4, var5, var6, var7);
    setRotationAngles(var2, var3, var4, var5, var6, var7, false);
  ...
  {
    super.render(var1, var2, var3, var4, var5, var6, var7);
    RunningPose(var2, var3, var4, var5, var6, var7, var1);
    this.noumenon1.render(var7);
    this.noumenon2.render(var7);
    this.noumenon3.render(var7);
    this.noumenon4.render(var7);
  ...
  public void setRotationAngles(float var1, float var2, float var3, float var4, float var5, float var6, boolean var7)
  {
    if (!var7)
    {
      this.noumenon2.rotateAngleY = (MathHelper.cos(var1 / 0.9595538F) * 0.1745329F * var2 + 0.0F);
      this.noumenon3.rotateAngleY = (MathHelper.cos(var1 / 0.9595538F) * 0.261799F * var2 + 0.0F);
      this.noumenon4.rotateAngleY = (MathHelper.cos(var1 / 0.9595538F) * 0.3490658F * var2 + 0.0F);
      this.thigh_R1.rotateAngleX = (MathHelper.cos(var1 / 0.9595538F) * -0.1745329F * var2 + 0.0F);
      this.thigh_R1.rotateAngleY = (MathHelper.cos(var1 / 0.9595538F) * 0.0872665F * var2 + 0.0F);
      this.leg_R1.rotateAngleX = (MathHelper.cos(var1 / 0.9595538F) * -0.1745329F * var2 + 0.994461F);
      this.leg_R1.rotateAngleY = (MathHelper.cos(var1 / 0.9595538F) * 0.0872665F * var2 + 0.0F);
      this.thigh_L1.rotateAngleX = (MathHelper.cos(var1 / 0.9595538F) * 0.1745329F * var2 + 0.0F);
      this.thigh_L1.rotateAngleY = (MathHelper.cos(var1 / 0.9595538F) * 0.0872665F * var2 + 0.0F);
      this.leg_L1.rotateAngleX = (MathHelper.cos(var1 / 0.9595538F) * 0.1745329F * var2 + 0.994461F);
      this.leg_L1.rotateAngleY = (MathHelper.cos(var1 / 0.9595538F) * 0.0872665F * var2 + 0.0F);
      this.thigh_R2.rotateAngleX = (MathHelper.cos(var1 / 0.9595538F) * 0.1745329F * var2 + 0.0F);
      this.thigh_R2.rotateAngleY = (MathHelper.cos(var1 / 0.9595538F) * 0.0872665F * var2 + 0.0F);
      this.leg_R2.rotateAngleX = (MathHelper.cos(var1 / 0.9595538F) * 0.1745329F * var2 + 0.994461F);
      this.leg_R2.rotateAngleY = (MathHelper.cos(var1 / 0.9595538F) * 0.0872665F * var2 + 0.0F);
      this.thigh_L2.rotateAngleX = (MathHelper.cos(var1 / 0.9595538F) * -0.1745329F * var2 + 0.0F);
      this.thigh_L2.rotateAngleY = (MathHelper.cos(var1 / 0.9595538F) * 0.0872665F * var2 + 0.0F);
      this.leg_L2.rotateAngleX = (MathHelper.cos(var1 / 0.9595538F) * -0.1745329F * var2 + 0.994461F);
      this.leg_L2.rotateAngleY = (MathHelper.cos(var1 / 0.9595538F) * 0.0872665F * var2 + 0.0F);
    }
  }

  public void RunningPose(float var1, float var2, float var3, float var4, float var5, float var6, Entity var7)
  {
    super.setRotationAngles(var1, var2, var3, var4, var5, var6, var7);

    this.noumenon1.rotateAngleX = (MathHelper.cos(var1 / 0.6333056F) * 0.0872665F * var2 + 0.0F);
    this.noumenon2.rotateAngleX = (MathHelper.cos(var1 / 0.6333056F) * 0.1745329F * var2 + -0.2712166F);
    this.noumenon3.rotateAngleX = (MathHelper.cos(var1 / 0.6333056F) * 0.261799F * var2 + -0.4520277F);
    this.noumenon4.rotateAngleX = (MathHelper.cos(var1 / 0.6333056F) * 0.3490658F * var2 + -0.1808111F);
    this.thigh_R1.rotateAngleX = (MathHelper.cos(var1 / 0.6333056F) * -0.1745329F * var2 + 0.0F);
    this.leg_R1.rotateAngleX = (MathHelper.cos(var1 / 0.6333056F) * -0.1745329F * var2 + 0.994461F);
    this.thigh_L1.rotateAngleX = (MathHelper.cos(var1 / 0.6333056F) * -0.261799F * var2 + 0.0F);
    this.leg_L1.rotateAngleX = (MathHelper.cos(var1 / 0.6333056F) * -0.261799F * var2 + 0.994461F);
    this.thigh_R2.rotateAngleX = (MathHelper.cos(var1 / 0.6333056F) * 0.261799F * var2 + 0.0F);
    this.leg_R2.rotateAngleX = (MathHelper.cos(var1 / 0.6333056F) * 0.261799F * var2 + 0.994461F);
    this.thigh_L2.rotateAngleX = (MathHelper.cos(var1 / 0.6333056F) * 0.1745329F * var2 + 0.0F);
    this.leg_L2.rotateAngleX = (MathHelper.cos(var1 / 0.6333056F) * 0.1745329F * var2 + 0.994461F);
  }
